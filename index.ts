        ...
        "body": JSON.stringify({
            ...
            "variables": {
                ...
                "staysSearchRequest": {
                    ...
                    "metadataOnly": false, "source":
                        "structured_search_input_header",
...
const main = async () => {
    ...
    const data = await staysSearch('Miami', 'Florida', 'FL');
    console.log(data);
    ...
    for await (const result of results) {
        ...
        const calData = await calendarSearch(id);
        console.log(calData);
        let price = result?.pricingQuote?.structuredStayDisplayPrice?.primaryLine?.price;
        if (price === undefined) {
            price = result?.pricingQuote?.structuredStayDisplayPrice?.primaryLine?.discountedPrice;
        }
