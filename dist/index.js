        ...
        "body": JSON.stringify({
            ...
            "variables": {
                ...
                "staysSearchRequest": {
                    ...
                    "metadataOnly": false, "source": "structured_search_input_header",
                    ...
                    "rawParams": [
                        ...
                        { "filterName": "placeId", "filterValues": [""] },
                        { "filterName": "priceFilterInputType", "filterValues": ["0"] },
                        { "filterName": "priceFilterNumNights", "filterValues": ["5"] },
                        { "filterName": "query", "filterValues": [city, stateCode] },
                        { "filterName": "refinementPaths", "filterValues": ["/homes"] },
                        { "filterName": "screenSize", "filterValues": ["large"] },
                        { "filterName": "tabId", "filterValues": ["home_tab"] },
                        { "filterName": "version", "filterValues": ["1.8.3"] }
                    ]
                }, "staysSearchM3Enabled": false, "staysSearchM6Enabled": false, "feedMapDecoupleEnabled": false
            }, "extensions": { "persistedQuery": { "version": 1, "sha256Hash": "72906bd6e5a6f41a04b391adadfb287106ea9209c6a2078d82d6568310d143e7" } }
        }),
        "method": "POST"
    });
    console.log('running');
...
const calendarSearch = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const res = yield fetch(`https://www.airbnb.com/api/v3/PdpAvailabilityCalendar?operationName=PdpAvailabilityCalendar&locale=en&currency=USD&variables=%7B%22request%22%3A%7B%22count%22%3A12%2C%22listingId%22%3A%22${id}%22%2C%22month%22%3A${month}%2C%22year%22%3A${year}%7D%7D&extensions=%7B%22persistedQuery%22%3A%7B%22version%22%3A1%2C%22sha256Hash%22%3A%228f08e03c7bd16fcad3c92a3592c19a8b559a0d0855a84028d1163d4733ed9ade%22%7D%7D`, {
        "headers": {
            ...
            "Referer": `https://www.airbnb.com/rooms/${id}?adults=1&children=0&infants=0&pets=0&check_in=2023-01-18&check_out=2023-01-20&source_impression_id=p3_1672363396_UDTEHGeCD8MwvNfT`,
            "Referrer-Policy": "strict-origin-when-cross-origin"
        },
        "body": null,
        "method": "GET"
...
const main = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const data = yield staysSearch('Miami', 'Florida', 'FL');
    console.log(data);
    ...
    let counter = 0;
    try {
        for (var _k = true, results_1 = __asyncValues(results), results_1_1; results_1_1 = yield results_1.next(), _a = results_1_1.done, !_a;) {
            ...
            try {
                ...
                const calData = yield calendarSearch(id);
                console.log(calData);
                let price = (_f = (_e = (_d = result === null || result === void 0 ? void 0 : result.pricingQuote) === null || _d === void 0 ? void 0 : _d.structuredStayDisplayPrice) === null || _e === void 0 ? void 0 : _e.primaryLine) === null || _f === void 0 ? void 0 : _f.price;
                if (price === undefined) {
                    price = (_j = (_h = (_g = result === null || result === void 0 ? void 0 : result.pricingQuote) === null || _g === void 0 ? void 0 : _g.structuredStayDisplayPrice) === null || _h === void 0 ? void 0 : _h.primaryLine) === null || _j === void 0 ? void 0 : _j.discountedPrice;
                }
        ...
        try {
            if (!_k && !_a && (_b = results_1.return)) yield _b.call(results_1);
        }
