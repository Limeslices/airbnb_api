...
let cookie = 'everest_cookie=1667673495.Iq7DpPli3wMXwRegDFCN.yV8_sdCrIie42N5FpOEc01Ffwq1B0uDYT_6cp0YsMrY; country=US; cdn_exp_2ab78baeda6c3fe9c=treatment; bev=1667673495_ODUyMGNjMDdhYjVi; OptanonAlertBoxClosed=NR; cdn_exp_e34f8847ee4f0c14f=treatment; _csrf_token=V4$.airbnb.com$sRKuo3ShQHc$R3uM1c8ui_tNFYSJtpAZdSTMBCleZQ_8I6DPYguwLXM=; _airbed_session_id=312d023ed5e0d0eb1bd1e57d87f590bb; sticky_locale=en; cdn_exp_9cbf277ff04e35316=treatment; cdn_exp_759647797802a2888=treatment; auth_jitney_session_id=8b3e65fd-8a30-4742-98fd-e2d3a46eab11; cdn_exp_7d88e310aadc73d9b=treatment; cdn_exp_875ac2fa405b6da87=control; flags=0; tzo=-360; _gcl_au=1.1.185822587.1672258873; _ga=GA1.1.889301866.1672258874; cfrmfctr=DESKTOP; frmfctr=wide; ak_bmsc=2F0748DD0C1C5F7AC5CA11056093C053~000000000000000000000000000000~; jitney_client_session_id=e1f69d14-6051-439f-878a-68072c27da3c; jitney_client_session_created_at=1672356189; cbkp=4; _ga_2P6Q8PGG16=GS1.1.1672356492.2.1.1672356492.60.0.0; _uetsid=76aaf2c087d011edb2d6dbbfe5218141; _uetvid=2ce5247086ed11eda3bb216922d41d86; _user_attributes={"enable_auto_translate":false,"guest_exchange":1,"device_profiling_session_id":"1667673495--9b020724e09e0e62cbbd3ca4","giftcard_profiling_session_id":"1672356187--c3643a7499cd1207481a6216","reservation_profiling_session_id":"1672356187--2761798cbd17178fe2c7d402","curr":"USD"}; previousTab={"id":"0db27623-d952-49ab-918f-d79f7b19dacd","url":"https://www.airbnb.com/s/Miami--Florida--United-States/homes?tab_id=home_tab&refinement_paths%5B%5D=%2Fhomes&flexible_trip_lengths%5B%5D=one_week&price_filter_input_type=0&price_filter_num_nights=5&query=Miami%2C%20FL&place_id=ChIJEcHIDqKw2YgRZU-t3XHylv8&date_picker_type=calendar&source=structured_search_input_header&search_type=autocomplete_click"}; jitney_client_session_updated_at=1672358008; bm_sv=7EFB9171C64FFB5B1AAEEFA58833B2D6~~1';
const staysSearch = (city, state, stateCode) => __awaiter(void 0, void 0, void 0, function* () {
    const res = yield fetch("https://www.airbnb.com/api/v3/StaysSearch?operationName=StaysSearch&locale=en&currency=USD", {
        "headers": {
            "accept": "*/*",
...
const main = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const data = yield staysSearch('Miami', 'Florida York', 'FL');
    console.log(data);
    ...
    for (let i = 0; i < results.length; i++) {
        ...
        // console.log(data);
        let price = (_d = (_c = (_b = (_a = results[i]) === null || _a === void 0 ? void 0 : _a.pricingQuote) === null || _b === void 0 ? void 0 : _b.structuredStayDisplayPrice) === null || _c === void 0 ? void 0 : _c.primaryLine) === null || _d === void 0 ? void 0 : _d.price;
        if (price === undefined) {
            price = (_h = (_g = (_f = (_e = results[i]) === null || _e === void 0 ? void 0 : _e.pricingQuote) === null || _f === void 0 ? void 0 : _f.structuredStayDisplayPrice) === null || _g === void 0 ? void 0 : _g.primaryLine) === null || _h === void 0 ? void 0 : _h.discountedPrice;
        }
